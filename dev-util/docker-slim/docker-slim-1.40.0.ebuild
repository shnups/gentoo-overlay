...
inherit go-module
GIT_COMMIT="a4bb798922820523fceedb9121f5bcfdfc9f2901"
EGO_SUM=(
...
SRC_URI="https://github.com/docker-slim/docker-slim/archive/${PV}.tar.gz -> ${P}.tar.gz ${EGO_SUM_SRC_URI}"
...
src_compile() {
	...
	for bin in "slim" "slim-sensor"
	do
		local ldflags=(
			-X "github.com/docker-slim/docker-slim/pkg/version.appVersionTag=${PV}"
			-X "github.com/docker-slim/docker-slim/pkg/version.appVersionRev=${GIT_COMMIT}"
