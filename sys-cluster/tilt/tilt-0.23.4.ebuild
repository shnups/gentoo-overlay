...
EGO_SUM=(
	...
	"github.com/AkihiroSuda/containerd-fuse-overlayfs v0.10.0/go.mod"
	...
	"github.com/bugsnag/bugsnag-go v1.5.3/go.mod"
	...
	"github.com/compose-spec/compose-go v1.0.8/go.mod"
	...
	"github.com/containerd/containerd v1.4.1-0.20200903181227-d4e78200d6da/go.mod"
	...
	"github.com/containerd/stargz-snapshotter v0.0.0-20200903042824-2ee75e91f8f9/go.mod"
	...
	"github.com/denisbrodbeck/machineid v1.0.0/go.mod"
	...
	"github.com/docker/go v1.5.1-1/go.mod"
	...
	"github.com/gdamore/tcell v1.1.3/go.mod"
	...
	"github.com/google/go-containerregistry v0.0.0-20200425101607-48f605c3b60a/go.mod"
	...
	"github.com/looplab/tarjan v0.0.0-20161115091335-9cc6d6cebfb5/go.mod"
	...
	"github.com/miekg/pkcs11 v0.0.0-20180817151620-df0db7a16a9e/go.mod"
	...
	"github.com/moby/buildkit v0.7.1-0.20200925001807-2b6cccb9b3e9/go.mod"
	...
	"github.com/rivo/tview v0.0.0-20180926100353-bc39bf8d245d/go.mod"
	...
	"github.com/tilt-dev/apimachinery v0.22.2-tilt-20210928"
	"github.com/tilt-dev/apimachinery v0.22.2-tilt-20210928/go.mod"
	"github.com/tilt-dev/browser v0.0.1"
	"github.com/tilt-dev/browser v0.0.1/go.mod"
	"github.com/tilt-dev/dockerignore v0.1.1"
	"github.com/tilt-dev/dockerignore v0.1.1/go.mod"
	"github.com/tilt-dev/fsevents v0.0.0-20200515134857-2efe37af20de"
	"github.com/tilt-dev/fsevents v0.0.0-20200515134857-2efe37af20de/go.mod"
	"github.com/tilt-dev/fsnotify v1.4.8-0.20210701141043-dd524499d3fe"
	"github.com/tilt-dev/fsnotify v1.4.8-0.20210701141043-dd524499d3fe/go.mod"
	"github.com/tilt-dev/go-get v0.2.1"
	"github.com/tilt-dev/go-get v0.2.1/go.mod"
	"github.com/tilt-dev/json-patch/v4 v4.8.1"
	"github.com/tilt-dev/json-patch/v4 v4.8.1/go.mod"
	"github.com/tilt-dev/localregistry-go v0.0.0-20200615231835-07e386f4ebd7"
	"github.com/tilt-dev/localregistry-go v0.0.0-20200615231835-07e386f4ebd7/go.mod"
	"github.com/tilt-dev/probe v0.3.1"
	"github.com/tilt-dev/probe v0.3.1/go.mod"
	"github.com/tilt-dev/tilt-apiserver v0.5.2"
	"github.com/tilt-dev/tilt-apiserver v0.5.2/go.mod"
	"github.com/tilt-dev/wmclient v0.0.0-20201109174454-1839d0355fbc"
	"github.com/tilt-dev/wmclient v0.0.0-20201109174454-1839d0355fbc/go.mod"
	...
	"github.com/tonistiigi/fsutil v0.0.0-20200724193237-c3ed55f3b481/go.mod"
	...
	"github.com/wojas/genericr v0.2.0/go.mod"
	...
	"go.starlark.net v0.0.0-20200615180055-61b64bc45990/go.mod"
	...
	"golang.org/x/tools v0.0.0-20200210192313-1ace956b0e17/go.mod"
	...
	"gopkg.in/d4l3k/messagediff.v1 v1.2.1/go.mod"
	"gopkg.in/dancannon/gorethink.v3 v3.0.5"
	"gopkg.in/dancannon/gorethink.v3 v3.0.5/go.mod"
	...
	"k8s.io/cli-runtime v0.22.2/go.mod"
	...
	"k8s.io/component-helpers v0.22.2/go.mod"
	...
	"sigs.k8s.io/controller-runtime v0.10.1/go.mod"
...
SRC_URI="https://tilt-dev/tilt/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz ${EGO_SUM_SRC_URI}"
...
src_compile() {
	...
	go build -trimpath -ldflags "${LDFLAGS[*]}" -o "${PN}" "${S}/cmd/${PN}" || die
}
