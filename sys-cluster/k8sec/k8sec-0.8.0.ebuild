...
EGO_VENDOR=(
	...
	"k8s.io/api v0.23.4 github.com/kubernetes/api"
	"k8s.io/apimachinery v0.23.4 github.com/kubernetes/apimachinery"
	"k8s.io/client-go v0.23.4 github.com/kubernetes/client-go"
)
