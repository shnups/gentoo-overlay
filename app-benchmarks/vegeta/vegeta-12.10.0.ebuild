...
GIT_COMMIT="074c53005b0c63139de2450675eed8b248a29cdd"
...
EGO_VENDOR=(
	...
	"github.com/rs/dnscache e0241e321417" # indirect
	"github.com/shurcooL/httpfs f1e31cf0ba5c" # indirect
	"github.com/shurcooL/vfsgen 0000e147ea92" # indirect
	"golang.org/x/mod v0.8.0 github.com/golang/mod" # indirect
	"golang.org/x/sync v0.1.0 github.com/golang/sync" # indirect
	"golang.org/x/sys v0.10.0 github.com/golang/sys" # indirect
	"golang.org/x/text v0.11.0 github.com/golang/text" # indirect
	"golang.org/x/tools v0.6.0 github.com/golang/tools" # indirect
)
