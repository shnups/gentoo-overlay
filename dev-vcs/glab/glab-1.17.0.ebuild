...
EGO_SUM=(
	...
	"github.com/AlecAivazis/survey/v2 v2.2.12/go.mod"
	...
	"github.com/gdamore/tcell/v2 v2.2.1/go.mod"
	...
	"github.com/rivo/tview v0.0.0-20210117162420-745e4ceeb711/go.mod"
	...
	"github.com/xanzy/go-gitlab v0.50.0/go.mod"
...
DESCRIPTION="A GitLab command line tool bringing GitLab's cool features to your command line"
HOMEPAGE="https://github.com/profclems/${PN}"
SRC_URI="https://github.com/profclems/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz ${EGO_SUM_SRC_URI}"
...
IUSE=""
RESTRICT="mirror"
DOCS=(LICENSE README.md SECURITY.md)
